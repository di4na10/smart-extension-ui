      ...
      <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
        <div class="card-panel">
          ...
          <div class="card-panel-description">
            ...
            <count-to :start-val="0" :end-val="totalTags" :duration="3000" class="card-panel-num" />
          </div>
        </div>
      </el-col>
      <el-col :xs="12" :sm="12" :md="12" :lg="6" class="card-panel-col">
...
import HostData from '@/views/ip-mac-port/services/hostData'
import TagData from '@/views/taglist/services/tagData'
import NetConfData from '@/views/alarm/services/alarmData'
